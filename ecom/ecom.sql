...
insert  into `orders`(`order_id`,`buyer_id`,`order_date`,`item_id`,`quantity`,`total_price`,`status`) values (18,25,'2024-12-03 21:18:10.264477',3,2,'344.00','pending');
...
insert  into `products`(`productid`,`productname`,`price`,`productcategory`,`productdescription`,`ownerid`,`productimage`,`productstock`,`discount_percentage`) values (3,'tea shirt','172.00','t-shirts','tea shirt',26,'uploads/tea_shirt.png',1,NULL),(4,'shirt','20.00','t-shirts','assssb',26,'uploads/tshirts.jpg',20,NULL),(7,'pants','15.00','pants','12412',26,'uploads/pants.png',10,NULL),(8,'amongus t-shirt','30.00','t-shirts','amongus',29,'uploads/tea_shirt.png',20,NULL);
...
insert  into `reviews`(`id`,`product_id`,`user_id`,`rating`,`comment`,`created_at`) values (1,7,26,5,'good pants','2024-12-02 10:11:51'),(2,8,29,5,'amongus usussusu','2024-12-02 14:41:46'),(3,8,25,2,'panget','2024-12-03 21:26:53');
